...
# IAM Policy for ECS Tasks (S3, Secrets Manager)
...
resource "aws_ecs_service" "app" {
  ...
  # Note: In AWS provider 5.x, these are set via attributes, not a block
  # The defaults (200% max, 100% min) are typically fine, but can be configured via AWS Console
